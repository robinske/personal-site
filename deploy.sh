...
s3cmd sync -r ./_site/error/index.html s3://blog.krobinson.me/error.html
echo "Deploying blog posts..."
s3cmd sync -r ./_site/posts/ s3://blog.krobinson.me/posts/

# deploy talks
echo "Deploying talks..."
s3cmd sync -r ./_site/talks/ s3://talks.krobinson.me
s3cmd sync -r ./_site/error/index.html s3://talks.krobinson.me/error.html
